<div class="fluid_container">
    ...
    <div data-thumb="<?php echo base_url();?><?php echo base_url();?>images/slides/thumbs/sea.jpg" data-src="<?php echo base_url();?>images/slides/sea.jpg">
    ...
    <div data-thumb="<?php echo base_url();?>images/slides/thumbs/shelter.jpg" data-src="<?php echo base_url();?>images/slides/shelter.jpg">
          <div class="camera_caption fadeFromBottom"> It supports captions, HTML elements and videos and <em>it's validated in HTML5</em> </div>
        </div>
